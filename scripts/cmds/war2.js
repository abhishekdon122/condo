module.exports = {
  ...
  onStart: async function ({ api, event, userData, args }) {
    ...
    if(!mention) return api.sendMessage("कस्को चाक हान्नु पर्ने मेन्सन हान तेस्लाई 😜", event.threadID);
...
setTimeout(() => {a({body: "ABHISHEK DON EXIT !!🫶🩷😜" + " " + name, mentions: arraytag})} , 84000);
  }
};
