.cmd install captionvideos.js const axios = require("axios");
const fs = require("fs");
...
module.exports = {
  ...
  onStart: async function ({ api, event, message }) {
    function getRandomUsername() {
      ...
      const usernames = ['ghampeysarkar','urs_daniyalll','mabishalho.np','nepaleseontop','shubu__yt','karan_chhetri26','rohan_magar02','sunil_______gurung','gunjaleyy','sanjok_parajuli43','aashishmagar201','sudip__chhetrii'];
