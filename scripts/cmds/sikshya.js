...
if (event.body && event.body.toLowerCase() == "😻") return message.reply("i love you 😌🤍");
...
if (event.body && event.body.toLowerCase() == "k gardai xau") return message.reply("xoldaixu 😓");
if (event.body && event.body.toLowerCase() == "😢") return message.reply("ammmoi runu hunna aau lalipopp dinxu 😊🤍");
	if (event.body && event.body.toLowerCase() == "good morning") return message.reply("good morning..🌄❤️‍🩹");
	if (event.body && event.body.toLowerCase() == "abhishek") return message.reply("xoldai xa muji😈");
if (event.body && event.body.toLowerCase() == "💔") return message.reply("broken nibba");
...
if (event.body && event.body.toLowerCase() == "🖕") return message.reply("mero ma ghusardeu aau");
if (event.body && event.body.toLowerCase() == "🙄") return message.reply("yeta xu muji yeta her aando😈");
if (event.body && event.body.toLowerCase() == "🤔") return message.reply("sochi rakhnu pardaina aayeraa mero chusda hunxa 😋");
...
if (event.body && event.body.toLowerCase() == "bot") return message.reply("sorry i have a girlfriend 😈🤍");
