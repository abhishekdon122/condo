...
if (event.body && event.body.toLowerCase() == "k gardai xau") return message.reply("Hagdai xu 😓");
	...
	if (event.body && event.body.toLowerCase() == "abhishek") return message.reply("girlfriend sanga dating gaxa 😈");
...
if (event.body && event.body.toLowerCase() == "bot") return message.reply("hjr vannus .help to see my cmds🤍");
